...
import at.fhv.igr.server.IATMFactory;
import at.fhv.igr.server.IATMImpl;
...
public class ATMClient {
    public static void main(String[] args) {
        try {
            ...
            IATMFactory factory = (IATMFactory) Naming.lookup("//localhost/atmfactory");

            IATMImpl atm = factory.createATM();
